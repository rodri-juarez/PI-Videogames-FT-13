...
Utilicé React para el Frontend y Redux como state management. Todos los componentes fueron desarrollados con CSS.
La SPA consume los datos de [RAWG](https://rawg.io/) a través de un Backend desarrollado en Node.JS
